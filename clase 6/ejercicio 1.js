...
resultado: es cualquier cosa, un numero, un texto, un objeto, etc. 
es lo que retorna la funcion si no arrojo un error
*/
...
try
{
    let resultado = funcionCatastrofica(20, 'error ya volvemos...', 5);
    console.log('salio todo bien :D ', resultado)
}
catch (error)
{
