...
La funcion pedirUsuario disparar un error llamado 'ForbiddenInformation' 
si el usuario elegido es el del id = 00000 Llamar a la funcion pedirUsuario 
dentro de la funcion pedirInformacion para cambiar el retorno de la funcion pedirInformacion. 
Considerar que la funcion pedirInformacion ahora tiene que capturar un error, 
cuando la capture debe disparar un error 'NetworkError'.
Ejemplo: function pedirUsuario()
puede disparar un error, devuelve un usuario 
function pedirInformacion()
let usuario = pedirUsuario(); 
considerar 'pedirUsuario' p   
